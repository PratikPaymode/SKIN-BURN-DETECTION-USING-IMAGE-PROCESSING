...
root.title(" skin burn Detection ")
...
#
lbl = tk.Label(root, text="skin burn Detection ", font=('times', 35,' bold '), height=1, width=60,bg="maroon1",fg="white")
lbl.place(x=0, y=0)
...
#    global fn
    ...
    if fn!="":
        ...
        if plant == 0:
            Cd=" degree 0c skin burn \n hospitals name \n Shreeyash Hospital ,Ashwathy Skin And Laser Clinic Khadki, Pune,"
        elif plant == 1:
             Cd="degree 1c skin burn\n Surya Sahyadri Hospital, Kasba Peth \n Sana Hospital"
        elif plant == 2:
            Cd="degree 2c skin burn \n Era's Bharti Hospital \n Chakan Criticare Hospital"
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='E:/code/skin cancer +burn100%', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
